...
const actionsheetItemStyle = tva({
  base: 'w-full flex-row items-center p-3 rounded-sm data-[disabled=true]:opacity-40 data-[disabled=true]:web:pointer-events-auto data-[disabled=true]:web:cursor-not-allowed hover:bg-background-subtle active:bg-background-subtle data-[focus=true]:bg-background-subtle web:data-[focus-visible=true]:bg-background-subtle data-[checked=true]:bg-background-subtle',
});

const actionsheetItemTextStyle = tva({
  base: 'text-text font-normal font-body tracking-md text-left mx-2',
  variants: {
    isTruncated: {
      true: '',
    },
