...
const selectTriggerStyle = tva({
  base: 'border border rounded flex-row items-center overflow-hidden data-[hover=true]:border data-[focus=true]:border-primary data-[disabled=true]:opacity-40 data-[disabled=true]:data-[hover=true]:border',
  variants: {
    size: {
      xl: 'h-12',
      lg: 'h-11',
    ...
    variant: {
      underlined:
        'border-0 border-b rounded-none data-[hover=true]:border-primary data-[focus=true]:border-primary data-[focus=true]:web:shadow-[inset_0_-1px_0_0] data-[focus=true]:web:shadow-primary-700 data-[invalid=true]:border-error data-[invalid=true]:web:shadow-error-700',
      outline:
        'data-[focus=true]:border-primary data-[focus=true]:web:shadow-[inset_0_0_0_1px] data-[focus=true]:data-[hover=true]:web:shadow-primary-600 data-[invalid=true]:web:shadow-[inset_0_0_0_1px] data-[invalid=true]:border-error data-[invalid=true]:web:shadow-error-700 data-[invalid=true]:data-[hover=true]:border-error',
      rounded:
        'rounded-full data-[focus=true]:border-primary data-[focus=true]:web:shadow-[inset_0_0_0_1px] data-[focus=true]:web:shadow-primary-700 data-[invalid=true]:border-error data-[invalid=true]:web:shadow-error-700',
    },
  },
});

const selectInputStyle = tva({
  base: 'px-3 placeholder:text-muted web:w-full h-full text pointer-events-none web:outline-none ios:leading-[0px] py-0',
  parentVariants: {
    size: {
      xl: 'text-xl',
      lg: 'text-lg',
