...
const checkboxIndicatorStyle = tva({
  base: 'justify-center items-center border bg-background rounded web:data-[focus-visible=true]:outline-none web:data-[focus-visible=true]:ring-2 web:data-[focus-visible=true]:ring-indicator-primary data-[checked=true]:bg-background data-[checked=true]:border-primary data-[hover=true]:data-[checked=false]:border data-[hover=true]:bg-background data-[hover=true]:data-[invalid=true]:border-error data-[hover=true]:data-[checked=true]:bg-background data-[hover=true]:data-[checked=true]:border-primary data-[hover=true]:data-[checked=true]:data-[disabled=true]:border-primary data-[hover=true]:data-[checked=true]:data-[disabled=true]:bg-background data-[hover=true]:data-[checked=true]:data-[disabled=true]:opacity-40 data-[hover=true]:data-[checked=true]:data-[disabled=true]:data-[invalid=true]:border-error data-[hover=true]:data-[disabled=true]:border data-[hover=true]:data-[disabled=true]:data-[invalid=true]:border-error data-[active=true]:data-[checked=true]:bg-background data-[active=true]:data-[checked=true]:border-primary data-[invalid=true]:border-error data-[disabled=true]:opacity-40',
  parentVariants: {
    size: {
...
const checkboxLabelStyle = tva({
  base: 'text-muted data-[checked=true]:text data-[hover=true]:text data-[hover=true]:data-[checked=true]:text data-[hover=true]:data-[checked=true]:data-[disabled=true]:text data-[hover=true]:data-[disabled=true]:text-muted data-[active=true]:text data-[active=true]:data-[checked=true]:text data-[disabled=true]:opacity-40 web:select-none',
  parentVariants: {
    size: {
      lg: 'text-lg',
      md: 'text-base',
