...
export const tableHeadStyle = tva({
  base: 'flex-1 px-6 py-[14px] text-left font-bold text-[16px] leading-[22px] text font-roboto',
});

export const tableRowStyleStyle = tva({
  base: 'border-0 border-b border-solid border bg-background',
  variants: {
    isHeaderRow: {
      true: '',
    },
...
export const tableDataStyle = tva({
  base: 'flex-1 px-6 py-[14px] text-left text-[16px] font-medium leading-[22px] text font-roboto',
});

export const tableCaptionStyle = tva({
  base: `${captionTableStyle} px-6 py-[14px] text-[16px] font-normal leading-[22px] text bg-background-subtle font-roboto`,
});
